...
import (
	...
	adi658v1alpha1 "github.com/adi658/sample-operator/pkg/apis/adi658/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &adi658v1alpha1.Sample{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &adi658v1alpha1.Sample{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileSample) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &adi658v1alpha1.Sample{}
...
func newPodForCR(cr *adi658v1alpha1.Sample) *corev1.Pod {
